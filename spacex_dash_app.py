...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df_new = filtered_df_new['class'].value_counts().reset_index()

        fig = px.pie(filtered_df_new, values='count', 
            names='class', 
            title=f'Success Rate in {entered_site}')
...
def get_scatter_chart(entered_site, payload_slide):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df, y='class', 
            ...
            title='Success Rate by Payload Mass (kg)')
        return fig
    else:
        ...
        fig = px.scatter(filtered_df, y='class', 
            x='Payload Mass (kg)', color = 'Booster Version Category',
            title=f'Success Rate by Payload Mass (kg) in {entered_site}')
        return fig
